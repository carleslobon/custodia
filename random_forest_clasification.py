...
def main():
    ...
    # Encode the label column using LabelEncoder for multi-class classification
    label_encoder = LabelEncoder()
    combined_df["label"] = label_encoder.fit_transform(combined_df["label"].str.strip())
    ...
    # Split the data into train and test sets using stratified sampling to preserve class distribution
    ...
    # Find the unique labels in the test data
    unique_labels = np.unique(y_test)

    # Print detailed classification report using labels found in the test set
